...
public class CompareVersionNumbers {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Comparison result: " + solution.compareVersion(version1, version2)); // Output: 0
        ...
        version1 = "0.1";
        version2 = "1.1";
        System.out.println("Comparison result: " + solution.compareVersion(version1, version2)); // Output: -1
    }
}
